    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photo_sizes', to='photo.PhotoEffect', verbose_name='photo effect')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30, unique=True, verbose_name='name')),
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('image', models.ImageField(upload_to='photo/watermarks', verbose_name='image')),
        ...
        migrations.AddField(
            ...
            name='watermark',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photo_sizes', to='photo.Watermark', verbose_name='watermark image'),
        ),
        migrations.AddField(
            model_name='photo',
            name='effect',
